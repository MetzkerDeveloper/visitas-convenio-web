        ...
        <table class="w-full min-w-[600px] border border-gray-300">
            <thead class="text-center bg-gray-100">
                <tr>
                    ...
                    <th class="px-4 py-2">Cidade Agendada</th>
                    <th class="px-4 py-2">Cidade Visitada</th>
                </tr>
            </thead>
            <tbody class="text-center bg-white">
                @forelse($cidadeVisitas as $cidadeVisita)
                    <tr class="border-t">
                        <td class="px-4 py-2">{{ $cidadeVisita->promotor }}</td>
                        <td class="px-4 py-2">{{ $cidadeVisita->cidade_agendada }}</td>
                        <td class="px-4 py-2">{{ $cidadeVisita->cidade_visitada }}</td>
                    </tr>
                @empty
                    <tr>
