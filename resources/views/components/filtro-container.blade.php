  ...
  <!-- Filtros -->
    <div  {{ $attributes->merge(['class' => 'relative mt-4 mb-4']) }} >
        <button id="dropdownButton" class="bg-blue-500 text-white px-4 py-2 rounded">
                {{ $title }}  <!-- Caso contrário, renderiza o título -->
        </button>
        <div id="dropdownMenu" class="dropdown-content absolute mt-2 max-w-max bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded shadow-lg hidden">
