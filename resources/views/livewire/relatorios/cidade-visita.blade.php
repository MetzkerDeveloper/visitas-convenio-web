            ...
            <table class="w-full min-w-[600px] border border-gray-300 dark:border-gray-700 rounded-xl overflow-hidden">
                <thead class="text-center bg-gray-100 dark:bg-gray-900">
                    <tr>
                        ...
                        <th class="px-4 py-2 text-gray-600 dark:text-gray-300">Cidade Agendada</th>
                        <th class="px-4 py-2 text-gray-600 dark:text-gray-300">Cidade Visitada</th>
                    </tr>
                </thead>
                <tbody class="text-center bg-white dark:bg-gray-800">
                    @forelse($cidadeVisitas as $cidadeVisita)
                        <tr class="border-t border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-900 transition">
                            <td class="px-4 py-2 text-gray-600 dark:text-gray-300 font-semibold">{{ $cidadeVisita->promotor }}</td>
                            <td class="px-4 py-2 text-gray-600 dark:text-gray-300">{{ $cidadeVisita->cidade_agendada }}</td>
                            <td class="px-4 py-2 text-gray-600 dark:text-gray-300">{{ $cidadeVisita->cidade_visitada }}</td>
                        </tr>
                    @empty
                        <tr>
                            <td colspan="3" class="px-4 py-2 text-center text-gray-400 dark:text-gray-500">
